...
brew install --cask --no-quarantine julia libreoffice modrinth obs zed blender kdenlive audacity inkscape raspberry-pi-imager mactex sidequest warp google-chrome lm-studio discord adobe-connect eqmac
