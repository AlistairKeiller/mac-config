...
# Client QOL mods: Not Enough Animations + BetterF3 (Font Scale: 0.7) + 3D Skin Layers + Presence Footsteps (Global Volume: 20%) + Eating Animation + Better Ping Display + Chat Heads + Bobby + Boat Item View + Make Bubbles Pop + ClearDespawn + Highlight + Detail Armor Bar
