...
brew install rustup-init python helix gitui jupyterlab font-jetbrains-mono font-monocraft font-monaspace
brew install --cask --no-quarantine julia discord warp google-chrome libreoffice modrinth zoom inkcsape kindle obs lapce wacom-tablet blender spotify sidequest
