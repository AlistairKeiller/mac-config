...
brew install --cask --no-quarantine julia libreoffice modrinth obs zed blender quarto kdenlive audacity inkscape mactex sidequest warp google-chrome lm-studio discord adobe-connect
