...
brew install --cask --no-quarantine julia discord warp google-chrome libreoffice modrinth zoom kindle obs zed blender spotify sidequest lm-studio quarto adobe-connect
