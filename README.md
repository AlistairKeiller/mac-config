...
# Install Programs
/opt/homebrew/bin/brew install julia rustup-init python pango ffmpeg python-lsp-server texlive gitui fish helix discord
...
# Install Numbers, Office 365, and grammarly
```
